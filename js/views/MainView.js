...
import EnvironmentTest from './sketches/EnvironmentTest/EnvironmentTest.js';
...
export class MainView extends BaseView {
        ...
        return new Promise(resolve => {
            if (this._cachedSketches[sketchId]) {
                ...
                import(path).then(module => {
                    ...
                    console.error("Sketch-Kit Error :: Check if sketch path exists :" + path);
                });
            }
        });
    }
    ...
    start() {
        ...
        this._sketch = new EnvironmentTest();
        this.el.appendChild(this._sketch.el);
