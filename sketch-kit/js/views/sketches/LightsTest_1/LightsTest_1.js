...
export default class LightsTest_1 extends BaseSketch {
    ...
    draw(time) {
        ...
        if(this._spotLight){
            ...
            this._directionLight.intensity = this.direction_intensity;
        }
    ...
    _createScene() {
     ...
     //   this.renderer.setClearColor(0xcccccc);
      ...
      //  this.renderer.toneMappingExposure = 1.0;
        ...
        this.controls.maxPolarAngle = 1.93;
    ...
    _loadTile() {
        return new Promise((resolve, reject) => {
            ...
            loader.load('assets/tile_terrazo.gltf', gltf => {
