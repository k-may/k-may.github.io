 ...
 * VR Version
 */
export default class EnvironmentTest_1 extends BaseSketch {

    constructor() {
        super('EnvironmentTest_1');

        this._createScene();
        this._loadModels();

        window.addEventListener( 'vrdisplaypointerrestricted', this._onPointerRestricted, false );
        window.addEventListener( 'vrdisplaypointerunrestricted', this._onPointerUnrestricted, false );

        //this.el.appendChild( WEBVR.createButton( this.renderer ) );
